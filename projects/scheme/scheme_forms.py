...
def do_define_form(expressions, env):
    ...
    if scheme_symbolp(signature):
        ...
        lambda_ = LambdaProcedure(signature.rest, body, env)
        env.define(signature.first, lambda_)
...
def do_lambda_form(expressions, env):
    ...
    "*** YOUR CODE HERE ***"
    body = expressions.rest
    lambda_ = LambdaProcedure(formals, body, env)
    return lambda_
    # END PROBLEM 7
...
def do_mu_form(expressions, env):
    ...
    "*** YOUR CODE HERE ***"
    body = expressions.rest
    lambda_ = MuProcedure(formals, body)
    return lambda_
    # END PROBLEM 11
